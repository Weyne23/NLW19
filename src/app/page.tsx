	...
	return (
		<main className="max-w-[1240x] mx-auto px-5 py-8 md:py-0">
			<div className="min-h-dvh flex flex-col justify-center gap-16">
				<div className="flex flex-col gap-8 items-center md:items-start w-full max-w-[550x]">
					<Image
						src={logo}
						alt="devstage"
						width={108.5}
				...
				<div className="flex gap-5 items-stretch flex-col md:flex-row">
					<div className="flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6">
						...
						<p className="text-gray-300 leading-relaxed text-sm md:text:base">
							...
							apaixonadas por criar soluções invadoras e
							compartilhar conhecimento. Vamos mergulhar nas
							tendências masi recentes em desenvolvimento de
					...
					<form className="bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6 w-full md:max-w-[440px]">
						...
						<div className="space-y-3">
							...
							<InputRoot>
								...
								<InputFilds type="email" placeholder="E-mail" />
							</InputRoot>
						</div>
						<Button type="submit">
							Confirmar
		...
		</main> /*Esse md: serve que a partir de um certo pixel ele aplica a regra dele, no caso aqui ele py-0 é para tirar o padding do texto*/
	);
}
